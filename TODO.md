...
- [x] AGAR Kneipe & Club (`agarkneipeclub`)
- [x] ArTik (`artik`)
- [x] Drifter's Club (`driftersclub`)
- [x] ELPI (`elpi`)
- [x] Hans Bunte Areal (`hansbunteareal`)
- [x] Jazzhaus Freiburg (`jazzhausfreiburg`)
- [x] Karree (`karree`)
- [x] LaLuna Freiburg (`lalunafreiburg`)
- [x] Mamita Club (`mamitaclub`)
- [x] Slow Club (`slowclub`)
- [x] The Great Räng Teng Teng (`thegreatraengtengteng`)
- [x] Waldsee (`waldsee`)

### Friedrichshafen

- [x] Kulturhaus Caserne (`kulturhauscaserne`)

### Heidelberg

- [x] Cave 54 (`cave54`)
- [x] halle02 (`halle02`)
- [x] Jinx Bar & Club (`jinxbarclub`)
- [x] klub_k (Karlstorbahnhof) (`klubkkarlstorbahnhof`)
- [x] TONIQ Club (`toniqclub`)
- [x] Villa Nachttanz (`villanachttanz`)
...
- [x] Agostea (`agostea`)
- [x] Alte Hackerei (`altehackerei`)
- [x] C2 OST (`c2ost`)
- [x] CEN Club (`cenclub`)
- [x] CODE Club (`codeclub`)
- [x] Die Stadtmitte (`diestadtmitte`)
- [x] Gotec Club (`gotecclub`)
- [x] Hello Club (`helloclub`)
- [x] La Louve (`lalouve`)
- [x] Nachtwerk Musikclub (`nachtwerkmusikclub`)
- [~] Substage (`_review`: `substage`)

### Konstanz

- [x] Berry's (`berrys`)
- [x] Grey (`grey`)
- [x] Kantine KN (`kantinekn`)
- [x] Kulturladen (KULA) (`kulturladenkula`)
- [x] P-Club (`pclub`)
- [x] Poly Areal (`polyareal`)
- [x] Steg4 (`steg4`)

### Mannheim

- [x] Alte Feuerwache (`altefeuerwache`)
- [x] Chaplin Club (`chaplinclub`)
- [x] Das Zimmer (`daszimmer`)
- [x] Disco Zwei (`discozwei`)
- [x] Hafen 49 (`hafen49`)
- [x] MS Connexion Complex (`msconnexioncomplex`)
- [x] SOHO The Club (`sohotheclub`)
- [x] Tiffany (`tiffany`)
...
- [x] 7GradX (`7gradx`)
- [x] Amici (`amici`)
- [x] Boa Discothek (`boadiscothek`)
- [x] Climax Institutes (`climaxinstitutes`)
- [x] Comodo Studios (`comodostudios`)
- [x] Fridas Pier (`fridaspier`)
- [x] Goldmark's (`goldmarks`)
- [x] Hi Life Club (`hilifeclub`)
- [x] Im Wizemann (`imwizemann`)
- [x] Kowalski (`kowalski`)
- [x] Lehmann Club (`lehmannclub`)
- [x] LKA Longhorn (`lkalonghorn`)
- [x] Offiss Club (`offissclub`)
- [x] Perkins Park (`perkinspark`)
- [x] Proton the Club (`protontheclub`)
- [x] Romantica (`romantica`)
- [x] Romy S. (`romys`)
- [x] Schankstelle (`schankstelle`)
- [x] Schräglage (`schraeglage`)
- [x] Wagenhallen (`wagenhallen`)
- [x] Wonders Club (`wondersclub`)

### Tübingen

- [x] Club 27 (`club27`)
- [x] Frau Holle (`frauholle`)
- [x] Sudhaus (`sudhaus`)
- [x] Top10 (`top10`)

### Ulm

- [x] Cabaret Eden (`cabareteden`)
- [x] Club Action (`clubaction`)
- [x] Club Noel (`clubnoel`)
- [x] Cocomo Club (`cocomoclub`)
- [x] Frau Berger (`frauberger`)
- [x] Gleis 44 (`gleis44`)
- [x] Hexenhaus (`hexenhaus`)
...
- [x] Colos-Saal (`colossaal`)

### Augsburg

- [x] 100 Hz Club (`100hzclub`)
- [x] Bar Italy (`baritaly`)
- [x] Kantine (`kantine`)
- [x] Kesselhaus (`kesselhaus`)
- [x] Ostwerk (`ostwerk`)
- [x] Provino Club (`provinoclub`)
- [x] Rockfabrik Augsburg (`rockfabrikaugsburg`)
- [x] Spectrum Club (`spectrumclub`)
- [x] Tanzbar Augsburg (`tanzbaraugsburg`)
- [x] The Soho Stage (`thesohostage`)

### Bamberg

- [x] Agostea (`agosteabamber`)
- [x] Kellerkinder (`kellerkinder`)
- [x] Live-Club (`liveclub`)
- [x] Ludwig (`ludwig`)
- [x] Sound-n-Arts (`soundnarts`)

### Bayreuth

- [x] Glashaus (Uni Bayreuth) (`glashausunibayreuth`)
...
- [x] Parktheater Kempten (`parktheaterkempten`)

### Landshut

- [x] Beat Schuppen (`beatschuppen`)
- [x] mea:mea (`meamea`)
- [x] Pulverfass (`pulverfass`)
- [x] Rocket Club (`rocketclub`)
- [x] Trixi Schneider (`trixischneider`)

### München

- [x] 089 Bar (`bar089`)
- [x] 333 Club (`club333`)
- [x] ABC – Alte Börse Club (`abc`)
- [x] Alte Utting (`alteutting`)
- [x] Americanos Werk3 (`americanos`)
- [x] Backstage (`backstage`)
- [x] Bahnwärter Thiel (`bahnwaerter`)
- [x] CAMP (`camp`)
- [x] Charlie (`charlie`)
- [x] DNA Club (`dna`)
- [x] Einstein Kultur (`einstein`)
- [x] Fat Cat (`fatcat`)
- [x] Favorit Bar (`favorit`)
- [x] Feierwerk (`feierwerk`)
- [x] Filmcasino (`filmcasino`)
- [x] Freiheitshalle (`freiheitshalle`)
- [x] G3 Club (`g3`)
- [x] Glockenbachwerkstatt (`glocke`)
- [x] Havana Club (`havana`)
- [x] Import Export (`importexport`)
- [x] Kafe Kult (`kafekult`)
- [x] Legal (`legal`)
- [x] Lucky Who (`luckywho`)
- [x] Max-Emanuel-Brauerei (`maxemanuel`)
- [x] Milchbar (`milchbar`)
- [x] Milla (`milla`)
- [x] Minna Thiel (`minna`)
- [x] Muffatwerk / Ampere (`muffatwerk`)
- [x] NachtKantine (`nachtkantine`)
- [x] Nachtwerk (`nachtwerk`)
- [x] Neuraum (`neuraum`)
- [x] Night Club (Bayerischer Hof) (`nightclub`)
- [x] NY.Club (`nyclub`)
- [x] P1 (`p1`)
- [x] Pacha München (`pacha`)
- [x] Palais Club (`palais`)
- [x] Paradiso Tanzbar (`paradiso`)
- [x] Park Café (`parkcafe`)
- [x] Pathos (`pathos`)
- [x] Pimpernel (`pimpernel`)
- [x] Prosecco (`prosecco`)
- [x] Rattlesnake Saloon (`rattlesnake`)
- [x] Rote Sonne (`rotesonne`)
- [x] Ruby Danceclub (`ruby`)
- [x] Schampus Club (`schampus`)
- [x] Schwabinger Podium (`podium`)
- [x] Strom (`strom`)
- [x] Substanz (`substanz`)
- [x] Sweet Club (`sweet`)
- [x] Tanzlokal Größenwahn (`groessenwahn`)
- [x] Technikum (`technikum`)
- [x] Theaterfabrik (`theaterfabrik`)
- [x] TonHalle (`tonhalle`)
- [x] Tresor by H'ugo's (`tresorbyhugos`)
- [x] Trisoux (`trisoux`)
- [x] Unter Deck (`unterdeck`)
- [x] Utopia (`utopia`)
- [x] Wannda Circus (`wannda`)
- [x] Xolo Club (`xolo`)
- [x] Zenith / Kesselhaus (`zenith`)

### Nürnberg

- [x] Club Fogon (`clubfogon`)
- [x] Club Stereo (`clubstereo`)
- [x] Der Cult (`dercult`)
- [x] Die Bombe (`diebombe`)
- [x] Die Rakete (`dierakete`)
- [x] Hirsch (`hirsch`)
- [x] Mach1 Club (`mach1club`)
- [x] Mississippi Queen (`mississippiqueen`)
- [x] Nachtkind (`nachtkind`)
- [x] Resi (`resi`)
- [x] WON – World of Nightlife (`wonworldofnightlife`)
- [x] Z-Bau (`zbau`)
...
- [x] Camera (`camera`)
- [x] Go! (`go`)
- [x] Zauberberg (`zauberberg`)

### Regensburg

- [x] Grand Slam (Alte Mälzerei) (`grandslamaltemaelzerei`)
- [x] Scala (`scala`)
- [x] Suite15 (`suite15`)
- [x] Velvet Room (`velvetroom`)
- [x] Zarap Zap Zap (`zarapzapzap`)
...
- [x] Immerhin (`immerhin`)
- [x] MS Zufriedenheit (`mszufriedenheit`)
...
- [x] ://about blank (`aboutblank`)
- [x] ACUD Club (`acudclub`)
- [x] Aeden (`aeden`)
- [x] Alte Kantine (`altekantine`)
- [x] Arkaoda Berlin (`arkaodaberlin`)
- [x] Astra Kulturhaus (`astrakulturhaus`)
- [x] Badehaus Berlin (`badehausberlin`)
- [x] Berghain / Panorama Bar (`berghainpanoramabar`)
- [x] Bi Nuu (`binuu`)
- [x] Birgit & Bier (`birgitbier`)
- [x] Bricks Berlin (`bricksberlin`)
- [x] Cassiopeia (`cassiopeia`)
- [x] Club der Visionäre (`clubdervisionaere`)
- [x] Clärchens Ballhaus (`claerchensballhaus`)
- [x] Crack Bellmer (`crackbellmer`)
- [x] Duncker Club (`dunckerclub`)
- [x] Else (`else`)
- [x] Festsaal Kreuzberg (`festsaalkreuzberg`)
- [x] Frannz Club (`frannzclub`)
- [x] Golden Gate (`goldengate`)
- [x] Gretchen (`gretchen`)
- [x] Hoppetosse (`hoppetosse`)
- [x] House of Weekend (`houseofweekend`)
- [x] Humboldthain Club (`humboldthainclub`)
- [x] Insel Berlin (Insel der Jugend) (`inselberlininselderjugend`)
- [x] Kaffee Burger (`kaffeeburger`)
- [x] Kater Blau (`katerblau`)
- [x] Kesselhaus in der Kulturbrauerei (`kesselhausinderkulturbrauerei`)
- [x] KitKatClub (`kitkatclub`)
- [x] Klunkerkranich (`klunkerkranich`)
- [x] LARK Berlin (ehem. Marie-Antoinette) (`larkberlinehemmarieantoinette`)
- [x] Lido (`lido`)
- [x] Maxxim Club (`maxximclub`)
- [x] OHM (`ohm`)
- [x] Paloma Bar (`palomabar`)
- [x] Panke Culture (`pankeculture`)
...
- [x] Sensorium (`sensorium`)
- [x] Sisyphos (`sisyphos`)
- [x] SO36 (`so36`)
- [x] SODA Club (`sodaclub`)
- [x] Suicide Club (`suicideclub`)
- [x] Süss. War Gestern (`suesswargestern`)
- [x] Tausend (`tausend`)
- [x] Tresor (`tresor`)
- [x] Void Club (`voidclub`)
- [x] YAAM (`yaam`)
- [x] Zenner (`zenner`)
